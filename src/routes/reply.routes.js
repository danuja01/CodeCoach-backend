...
import { createReply, deleteReply, getReplies, updateReply } from '@/controllers/reply';
...
replyRouter.get('/get/:id', authorizer(['ADMIN', 'LECTURER', 'STUDENT']), tracedAsyncHandler(getReplies));

// Route for deleting a reply
replyRouter.delete('/delete/:id', authorizer(['ADMIN', 'LECTURER', 'STUDENT']), tracedAsyncHandler(deleteReply));
